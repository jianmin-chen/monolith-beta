    ...
    <>
      ...
      <header>
        <motion.div
          ...
          <h1>monolith.</h1>
          <h1>
            a board that'll let you control your computer just by{' '}
            <i>thinking</i>.
          </h1>
        </motion.div>
        <motion.div
        ...
        <div className="features">
          <div>
            ...
            <p>
              ...
              up to eight channels with an eventual optional to add more
              channels with a addon board.
            </p>
          </div>
          <div>
            <h2>bluetooth.</h2>
            <p>
              To interface with out board, data over Bluetooth is supported,
      ...
      <section className="section" id="blue">
        <h1>
          we’re building more than just the most financially accessible board,
      ...
      <section className="section" id="about">
        ...
        <p>
          ...
          , <a href="https://braindump.ing">JC</a>, <a href="TODO">Sophia</a>,
          and <a href="TODO">Nila</a>) working on building a complete,
          ...
          this data. We work in person in Burlington, VT during five day
          sprints, although we've also done a five day sprint in San Francisco.
        </p>
        <p>
          EEG hardware are expensive, with the average processing board costing
          ...
          1/5th of the price, and 1/5th the time.
        </p>
        <h1>[timeline]</h1>
        <p>
          ...
          computer using an ESP32. It's completely open sourced and in active
          development on{' '}
          <a
            className="link"
            href="https://github.com/Monolith-BCI/Trillium-PCB">
            GitHub
          </a>
          .
        </p>
        <p>
          Currently, our roadmap is to finalize board development and finish the
          rest of the pipeline by the end of summer 2024, and begin shipping out
          preordered boards. The rest of the pipeline entails three very
          specific tasks: to a) productize our dashboard and use it to b)
          collect data from various groups to c) train a set of models for
          detecting modalities, such as left/right/up/down movement.
        </p>
        <p id="funding">
          We're currently looking for funding to be able to work full-time on
          this during the summer of 2024. If you are interested or know someone
          who would be interested in even giving a small grant, email us at
          monolith[at]monolithbci[dot]com.
        </p>
